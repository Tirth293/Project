...
<html>
<head>
<title>Tours and Travels Website | Admin manage Issues</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="http://localhost/Tours%20&%20Travel%20%20Website/admin/dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Issues</li>
            </ol>
...
{				?>		
						  <tr>
							<td width="120">#000<?php echo htmlentities($result->id);?></td>
